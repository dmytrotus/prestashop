...
include_once(_PS_MODULE_DIR_.'ps_cozastore_imageslider/Ps_HomeSlide.php');
...
class Ps_ImageSlider extends Module implements WidgetInterface
{
    ...
    {
        $this->name = 'ps_cozastore_imageslider';
        ...
        $this->templateFile = 'module:ps_cozastore_imageslider/views/templates/hook/slider.tpl';
    }
